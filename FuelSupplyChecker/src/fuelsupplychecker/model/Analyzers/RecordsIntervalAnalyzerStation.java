 ...
 * @author michi
 */
public class RecordsIntervalAnalyzerStation {
    private ArrayList<StationAnalyzer> recordsIntervalAnalysis;
	public ArrayList<StationAnalyzer> getRecordsIntervalAnalysis() {
    ...
    private void setData()
    {
    	...
    	for(StationAnalyzer column:recordsIntervalAnalysis)
    	{
    ...
    public RecordsIntervalAnalyzerStation(ArrayList<BaseRecordAnalyzer> recordsIntervalAnalysis) {
        
        this.recordsIntervalAnalysis = new ArrayList<>();
        
        for (BaseRecordAnalyzer rec : recordsIntervalAnalysis)
        {
            this.recordsIntervalAnalysis.add((StationAnalyzer)rec);
        }
    }
