 ...
 * @author michi
 */
public class RecordsIntervalAnalyzerTerminal {
     private ArrayList<TerminalAnalyzer> recordsIntervalAnalysis;
	public ArrayList<TerminalAnalyzer> getRecordsIntervalAnalysis() {
    ...
    private void setData()
    {
    	...
    	for(TerminalAnalyzer column:recordsIntervalAnalysis)
    	{
     ...
     public RecordsIntervalAnalyzerTerminal(ArrayList<BaseRecordAnalyzer> recordsIntervalAnalysis) {
        
        this.recordsIntervalAnalysis = new ArrayList<>();
        
        for (BaseRecordAnalyzer rec : recordsIntervalAnalysis)
        {
            this.recordsIntervalAnalysis.add((TerminalAnalyzer)rec);
        }
    }
