 ...
 * @author michi
 */
public class RecordsIntervalAnalyzerTank {
    
    private ArrayList<TankAnalyzer> recordsIntervalAnalysis; 
    ...
    private void setData()
    {
    	...
    	for(TankAnalyzer column:recordsIntervalAnalysis)
    	{
    ...
    public RecordsIntervalAnalyzerTank()
    {
        
    }
    
    
    public RecordsIntervalAnalyzerTank(ArrayList<BaseRecordAnalyzer> recordsIntervalAnalysis) {
        
        this.recordsIntervalAnalysis = new ArrayList<>();
        
        for (BaseRecordAnalyzer rec : recordsIntervalAnalysis)
        {
            this.recordsIntervalAnalysis.add((TankAnalyzer)rec);
        }
    }

    
    public ArrayList<TankAnalyzer> getRecordsIntervalAnalysis() {
        return recordsIntervalAnalysis;
    }

    public void setRecordsIntervalAnalysis(ArrayList<TankAnalyzer> recordsIntervalAnalysis) {
