 ...
 * @author michi
 */
public class RecordsIntervalAnalyzerTruck {
     private ArrayList<TruckAnalyzer> recordsIntervalAnalysis;
	private Date startDate;
	private Date endDate; 
	
	public ArrayList<TruckAnalyzer> getRecordsIntervalAnalysis() {
    ...
    private void setData()
    {
    	...
    	for(TruckAnalyzer column:recordsIntervalAnalysis)
    	{
     ...
     public RecordsIntervalAnalyzerTruck(ArrayList<BaseRecordAnalyzer> recordsIntervalAnalysis) {
        
        this.recordsIntervalAnalysis = new ArrayList<>();
        
        for (BaseRecordAnalyzer rec : recordsIntervalAnalysis)
        {
            this.recordsIntervalAnalysis.add((TruckAnalyzer)rec);
        }
    }
